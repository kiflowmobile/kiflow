...
LATERAL (
  ...
  "mainPoint": "Не доводь. Зніми опір — і веди далі."
    ...
    ('{
      "options": [
        "Купити",
        "Дозволяє уникнути конфлікту, не відповідати на заперечення",
        "Допомагає перевести фокус на емоції клієнта",
        "Дає можливість клієнту самому сформулювати умову, за якої він готовий"
      ],
...
'::jsonb, 24, 'content', NULL),
  ...
  "mainPoint": "Порівняння — це спосіб перевести емоцію у факти та створити довіру."
    ...
    ('{
      "options": [
        "Довести клієнту, що інші варіанти гірші",
        "Створити відчуття терміновості, щоб прискорити рішення",
        "Перевести діалог з емоційної площини у раціональну через спільний аналіз варіантів",
        "Запропонувати додаткову послугу як бонус"
      ],
      "question": "Що є ключовим у техніці уроку 5?",
      "correctAnswer": 3
    }'::jsonb, 32, 'quiz', 'Тест'),
...
'::jsonb, 52, 'content', NULL),
    ('{
  "tips": [
    "Не знижуй ціну — знайди розумну альтернативу",
    "Уточни, що саме здається дорогим",
    "Пропонуй адаптацію рішення без втрати цінності"
  ],
  "example": "«Можемо залишити той самий стиль, але використати інший матеріал — він дешевший, але виглядає майже ідентично.»",
  "mainPoint": "Справжня гнучкість — не у знижках, а в точних рішеннях."
}
'::jsonb, 53, 'quiz', 'Тест'),
