...
LATERAL (
  ...
  "mainPoint": "Не доводь. Зніми опір — і веди далі."
    ...
    ('{}'::jsonb, 16, 'ai', 'AI аналіз'),
    ('{}'::jsonb, 17, 'ai', 'AI аналіз'),
    ('{}'::jsonb, 18, 'ai', 'AI аналіз')
...
LATERAL (
    ...
    -- Урок 4
    ('{ "video": { "mux": "JbOkRHfYcYtzDGJBFowZkpLcB00ZT3I02fbh5XaMr02VVw" } }'::jsonb, 19, 'video', 'Вступне відео'),
    ('{
  "tips": [
...
'::jsonb, 20, 'content', NULL),
    ...
    ('{}'::jsonb, 22, 'ai', 'AI аналіз'),
    ('{}'::jsonb, 23, 'ai', 'AI аналіз'),
    ('{}'::jsonb, 24, 'ai', 'AI аналіз'),

    -- Урок 5
    ('{ "video": { "mux": "u3fgejYsiIX74VkKXtK8FJgU9005l006Ufe7A363GgZ3Q" } }'::jsonb, 25, 'video', 'Вступне відео'),
    ('{
  "tips": [
  ...
  "mainPoint": "Порівняння — це спосіб перевести емоцію у факти та створити довіру."
    ...
    ('{}'::jsonb, 29, 'ai', 'AI аналіз'),
    ('{}'::jsonb, 30, 'ai', 'AI аналіз'),

    -- Урок 6
    ('{ "video": { "mux": "ZHLvOCOjvcqwwR01d02lceueQNuDJWokR6PKyEThLjXJI" } }'::jsonb, 31, 'video', 'Вступне відео'),
    ('{
  "tips": [
...
LATERAL (
    ...
    -- Урок 7
    ('{ "video": { "mux": "Spv4YMykIO0100cUiBQY4duKpof9ZIF00pPmJmn63SXUn4" } }'::jsonb, 37, 'video', 'Вступне відео'),
    ('{
  "tips": [
  ...
  "mainPoint": "Історії — це мова довіри. Через досвід переконувати легше, ніж через аргументи."
    ...
    -- Урок 8
    ('{ "video": { "mux": "dE00eeyHPIfHZUPRF02Wr00BTeAjiIhFOwmK02EQ2qbzwsI" } }'::jsonb, 43, 'video', 'Вступне відео'),
    ('{
  "tips": [
...
'::jsonb, 45, 'quiz', 'Тест'),
    ('{}'::jsonb, 46, 'ai', 'AI аналіз'),
    ('{}'::jsonb, 47, 'ai', 'AI аналіз'),
    ('{}'::jsonb, 48, 'ai', 'AI аналіз'),

    -- Урок 9
    ('{ "video": { "mux": "Zlf4CsIftT9o5iedOcMbGLcAKBHkwCNPiUm7Z7erZns" } }'::jsonb, 49, 'video', 'Вступне відео'),
    ('{
    "tips": [
        "Не переконуй клієнта, а став запитання",
        "Використовуй силу запитання замість аргументів",
    ...
    ('{}'::jsonb, 52, 'ai', 'AI аналіз'),
    ('{}'::jsonb, 53, 'ai', 'AI аналіз'),
