...
CROSS JOIN (
  VALUES
    ('Основний модуль 1', 'Містить усі навчальні слайди курсу Інтерно', 1),
    ('Основний модуль 2', 'Містить усі навчальні слайди курсу Інтерно', 2),
    ('Основний модуль 3', 'Містить усі навчальні слайди курсу Інтерно', 3)
...
LATERAL (
    VALUES
    -- Урок 1
    ('{"content": ""}'::jsonb, 1, 'text', 'М’яка сила. Айкідо (амортизація + приєднання)'),
    ('{
  ...
  "mainPoint": "Не доводь. Зніми опір — і веди далі."
    ...
    ('{}'::jsonb, 5, 'ai', 'AI аналіз'),
    ('{}'::jsonb, 6, 'ai', 'AI аналіз'),
    ('{}'::jsonb, 7, 'ai', 'AI аналіз'),


    -- Урок 2
    ('{"content": ""}'::jsonb, 8, 'text', 'Уточнення заперечення'),
    ('{
    ...
    ('{}'::jsonb, 12, 'ai', 'AI аналіз'),
    ('{}'::jsonb, 13, 'ai', 'AI аналіз'),
    ('{}'::jsonb, 14, 'ai', 'AI аналіз'),
    -- Урок 3
    ('{"content": ""}'::jsonb, 15, 'text', 'Що могло би вас переконати'),
    ('{
    ...
    ('{}'::jsonb, 19, 'ai', 'AI аналіз'),
    ('{}'::jsonb, 20, 'ai', 'AI аналіз'),
    ('{}'::jsonb, 21, 'ai', 'AI аналіз')
...
LATERAL (
    ...
    -- Урок 4
    ('{"content": ""}'::jsonb, 22, 'text', 'Саме тому'),
...
'::jsonb, 24, 'content', NULL),
    ...
    ('{}'::jsonb, 26, 'ai', 'AI аналіз'),
    ('{}'::jsonb, 27, 'ai', 'AI аналіз'),
    ('{}'::jsonb, 28, 'ai', 'AI аналіз'),

    -- Урок 5
    ('{"content": ""}'::jsonb, 29, 'text', 'Давайте порівняємо'),
  ...
  "mainPoint": "Порівняння — це спосіб перевести емоцію у факти та створити довіру."
    ...
    ('{}'::jsonb, 33, 'ai', 'AI аналіз'),
    ('{}'::jsonb, 34, 'ai', 'AI аналіз'),
    ('{}'::jsonb, 35, 'ai', 'AI аналіз'),

    -- Урок 6
    ('{"content": ""}'::jsonb, 36, 'text', 'Цінова / часова декомпозиція'),
...
'::jsonb, 38, 'content', NULL),
    ...
    ('{}'::jsonb, 40, 'ai', 'AI аналіз'),
    ('{}'::jsonb, 41, 'ai', 'AI аналіз'),
    ('{}'::jsonb, 42, 'ai', 'AI аналіз')
...
LATERAL (
    ...
    -- Урок 7
    ('{"content": ""}'::jsonb, 43, 'text', 'Приклад із практики'),
  ...
  "mainPoint": "Історії — це мова довіри. Через досвід переконувати легше, ніж через аргументи."
    ...
    ('{}'::jsonb, 47, 'ai', 'AI аналіз'),
    ('{}'::jsonb, 48, 'ai', 'AI аналіз'),
    ('{}'::jsonb, 49, 'ai', 'AI аналіз'),

    -- Урок 8
    ('{"content": ""}'::jsonb, 50, 'text', 'Посилання на норми, практику, авторитети'),
...
'::jsonb, 53, 'quiz', 'Тест'),
    ('{}'::jsonb, 54, 'ai', 'AI аналіз'),
    ('{}'::jsonb, 55, 'ai', 'AI аналіз'),
    ('{}'::jsonb, 56, 'ai', 'AI аналіз'),

    -- Урок 9
    ('{ "video": { "mux": "Zlf4CsIftT9o5iedOcMbGLcAKBHkwCNPiUm7Z7erZns" } }'::jsonb, 57, 'video', 'Альтернатива замість поступки'),
    ('{
    "tips": [
        "Не переконуй клієнта, а став запитання",
        "Використовуй силу запитання замість аргументів",
    ...
    ('{}'::jsonb, 60, 'ai', 'AI аналіз'),
    ('{}'::jsonb, 61, 'ai', 'AI аналіз'),
    ('{}'::jsonb, 62, 'ai', 'AI аналіз')
